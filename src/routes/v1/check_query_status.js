        ...
        try {
            ...
            if (queryQueue) {
                ...
                if (job === null) {
                    ...
                    if (returnvalue && !returnvalue.error && returnvalue.response.type === 'Buffer') {
                        returnvalue.response = JSON.parse(lz4.decode(Buffer.from(returnvalue.response)).toString());
                    } // otherwise it hasn't been compressed
