...
describe("Testing v1.1 endpoints", () => {
  ...
  const gene2chemical_query = JSON.parse(
    fs.readFileSync(path.join(example_folder, "query_chemicals_physically_interacts_with_genes.json")),
  );
  const disease2gene_query = JSON.parse(
    fs.readFileSync(path.join(example_folder, "query_genes_relate_to_disease.json")),
  );
  const query_using_earlier_trapi_spec = JSON.parse(
    fs.readFileSync(path.join(old_spec_folder, "query_genes_relate_to_disease.json")),
  );
  const query_without_category = JSON.parse(
    fs.readFileSync(path.join(example_folder, "query_without_input_category.json")),
  );
  ...
  test("POST /v1/query with gene2chemical query", async () => {
    const mychem_query_3_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_3_input.json")),
    );
    const mychem_query_4_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_4_input.json")),
    );
    const mychem_query_5_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_5_input.json")),
    );
    const mychem_query_6_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_6_input.json")),
    );
    const mychem_query_7_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_7_input.json")),
    );
    const mychem_query_8_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_8_input.json")),
    );
    const mychem_query_9_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/mychem_query_9_input.json")),
    );
    const big_sri_input = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/big_sri_input.json")),
    );
    const big_sri_input_2 = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/big_sri_input_2.json")),
    );
    ...
    axios.default.mockImplementation(async qData => {
      ...
      if (
        ...
        res = [
          ...
          { query: "A0A024RB77", notfound: true },
          { query: "B4DDL9", notfound: true },
          { query: "E7ESI2", notfound: true },
          { query: "G3V5T9", notfound: true },
          {
            query: "P24941",
            _id: "XZXHXSATPCNXJR-ZIADKAODSA-N",
            _score: 9.885763,
            drugcentral: { _license: "http://bit.ly/2SeEhUy", xrefs: { chembl_id: ["CHEMBL502835", "CHEMBL3039504"] } },
          },
          {
            query: "P24941",
            _id: "BCFGMOOMADDAQU-UHFFFAOYSA-N",
            _score: 9.098851,
            drugcentral: { _license: "http://bit.ly/2SeEhUy", xrefs: { chembl_id: ["CHEMBL1201179", "CHEMBL554"] } },
          },
          {
            query: "P24941",
            _id: "MLDQJTXFUGDVEO-UHFFFAOYSA-N",
            _score: 9.098851,
            drugcentral: { _license: "http://bit.ly/2SeEhUy", xrefs: { chembl_id: ["CHEMBL1336", "CHEMBL1200485"] } },
          },
          {
            query: "P24941",
            _id: "REFJWTPEDVJJIY-UHFFFAOYSA-N",
            _score: 8.601126,
            drugcentral: { _license: "http://bit.ly/2SeEhUy", xrefs: { chembl_id: "CHEMBL50" } },
          },
          {
            query: "P24941",
            _id: "AHJRHEGDXFFMBM-UHFFFAOYSA-N",
            _score: 8.601126,
            drugcentral: { _license: "http://bit.ly/2SeEhUy", xrefs: { chembl_id: ["CHEMBL189963", "CHEMBL2364621"] } },
          },
          {
            query: "P24941",
            _id: "VERWOWGGCGHDQE-UHFFFAOYSA-N",
            _score: 8.601126,
            drugcentral: { _license: "http://bit.ly/2SeEhUy", xrefs: { chembl_id: "CHEMBL2403108" } },
          },
        ];
      }
      if (qData.url === "https://automat.transltr.io/ctd/1.3/query") {
        res = {
          message: {
            query_graph: {
              nodes: {
                n0: { ids: ["NCBIGene:1017"], categories: ["biolink:Gene"], is_set: false, constraints: [] },
                n1: { ids: null, categories: ["biolink:SmallMolecule"], is_set: false, constraints: [] },
              },
              edges: {
                e01: {
                  subject: "n0",
                  object: "n1",
                  knowledge_type: null,
                  predicates: ["biolink:decreases_molecular_interaction"],
          ...
          log_level: null,
          workflow: [{ runner_parameters: null, id: "lookup", parameters: null }],
          submitter: "infores:bte",
        };
      }
      if (
        qData.url === "https://biothings.ncats.io/bindingdb/query" &&
        qData.data === "q=A0A024RB10,A0A024RB77,B4DDL9,E7ESI2,G3V5T9,P24941&scopes=subject.uniprot.accession"
      ) {
      ...
      if (
        ...
        res = JSON.parse(
          fs.readFileSync(path.resolve(__dirname, `../data/api_results/bindingdb_query_${qData.params.from}.json`)),
        );
      }
      if (
        qData.url === "https://mychem.info/v1/query" &&
        arrEquals(qData.data?.q, [
          "CHEMBL502835",
          "CHEMBL3039504",
          "CHEMBL1201179",
          "CHEMBL554",
  ...
  test("POST /v1/query with disease2gene query", async () => {
    const big_sri_input_3 = JSON.parse(
      fs.readFileSync(path.resolve(__dirname, "../data/api_results/big_sri_input_3.json")),
    );
    ...
    axios.default.mockImplementation(qData => {
      ...
      if (
        qData.url === "https://mygene.info/v3/query" &&
        qData.data === "q=MONDO:0005737&scopes=clingen.clinical_validity.mondo"
      ) {
      ...
      if (
        qData.url === "https://biothings.ncats.io/semmeddb/query" &&
        arrEquals(qData.data?.q?.[0], ["C0282687", "CAUSES", "gngm", 1, 1])
      ) {
        res = { max_total: 0, hits: [{ query: ["C0282687", "CAUSES", "gngm", 1, 1], notfound: true }] };
      }
      if (
        qData.url === "https://biothings.ncats.io/semmeddb/query" &&
        arrEquals(qData.data?.q?.[0], ["C0282687", "PART_OF", "gngm", 1, 1])
      ) {
        res = { max_total: 0, hits: [{ query: ["C0282687", "PART_OF", "gngm", 1, 1], notfound: true }] };
      }
      if (
        qData.url === "https://biothings.ncats.io/semmeddb/query" &&
        arrEquals(qData.data?.q?.[0], ["C0282687", "ASSOCIATED_WITH", "gngm", 1, 1])
      ) {
        res = {
          max_total: 8,
          hits: [
            {
              query: ["C0282687", "ASSOCIATED_WITH", "gngm", 1, 1],
              _id: "118612906",
              _score: 19.9111,
              object: { name: "Hemorrhagic Fever, Ebola", umls: "C0282687" },
              pmid: 11752702,
              predicate: "ASSOCIATED_WITH",
              subject: { name: "Genetic Structures", umls: "C1136352" },
            },
            {
              query: ["C0282687", "ASSOCIATED_WITH", "gngm", 1, 1],
              _id: "142375549",
              ...
              pmid: 26376249,
              predicate: "ASSOCIATED_WITH",
              subject: { name: "TIE1 gene", umls: "C1539965" },
            },
            {
              query: ["C0282687", "ASSOCIATED_WITH", "gngm", 1, 1],
              _id: "185194271",
              ...
              pmid: 32161708,
              predicate: "ASSOCIATED_WITH",
              subject: { name: "IMPACT gene", umls: "C1825598" },
            },
            {
              query: ["C0282687", "ASSOCIATED_WITH", "gngm", 1, 1],
              _id: "149589561",
            ...
            },
            {
              ...
              pmid: 17940958,
              predicate: "ASSOCIATED_WITH",
              subject: { name: "AXL gene", umls: "C0812237" },
            },
            {
              query: ["C0282687", "ASSOCIATED_WITH", "gngm", 1, 1],
              _id: "187446981",
            ...
            },
            {
              ...
              pmid: 34166464,
              predicate: "ASSOCIATED_WITH",
              subject: { name: "STAT3 gene", umls: "C1367307" },
            },
          ],
        };
      }
      if (
        qData.url === "https://biothings.ncats.io/pfocr/query" &&
        qData.data === "q=D019142&scopes=associatedWith.mentions.diseases.mesh"
      ) {
        res = {
          max_total: 1,
          hits: [
            {
              query: "D019142",
              _id: "PMC7725765__fpubh-08-596944-g0001.jpg",
              _score: 10.558324,
              associatedWith: {
                figureUrl: "https://www.ncbi.nlm.nih.gov/pmc/articles/PMC7725765/bin/fpubh-08-596944-g0001.jpg",
                mentions: { genes: { ncbigene: ["6301"] } },
                pmc: "PMC7725765",
                title:
                  "Pathway diagram for pathogen spill-over to humans from animals describes three distinct processes",
              },
            },
          ],
        };
      ...
      if (
        qData.url === "https://myvariant.info/v1/query" &&
        qData.data === "q=DOID:4325&scopes=civic.evidence_items.disease.doid"
      ) {
        res = { max_total: 0, hits: [{ query: ["C0282687", "PART_OF", "gngm", 1, 1], notfound: true }] };
      }
        ...
        res = {
          message: {
            query_graph: {
              ...
              edges: {
                e01: { predicates: ["biolink:increases_expression_of"], subject: "n0", object: "n1", constraints: [] },
              },
            },
            knowledge_graph: { nodes: {}, edges: {} },
            results: [],
          ...
          logs: [
            {
              timestamp: "2023-01-27T02:54:54.360512",
              level: "INFO",
              message: "Normalized curie: MONDO:0005737 to UMLS:C0282687",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:54.490870",
              level: "INFO",
              message: "Converted category biolink:Disease to biolink:Disease using Biolink semantic operations.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:54.490891",
              level: "INFO",
              message: "Converted category biolink:Gene to biolink:Gene using Biolink semantic operations.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:54.499238",
              level: "INFO",
              message:
                "Converted predicate biolink:increases_expression_of to biolink:increases_expression_of using Biolink semantic operations.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:54.697830",
              level: "INFO",
              message: "Disease with curie UMLS:C0282687 does not exist in the database.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:54.698874",
              level: "INFO",
              message: "Disease with curie UMLS:C0282687 does not exist in the database.",
              code: null,
            },
            { timestamp: "2023-01-27T02:54:54.708116", level: "INFO", message: "No results found.", code: null },
          ],
          id: "5a9c6638-3a5c-44f6-b368-046caa28fa10",
          status: "Success",
          description: null,
          workflow: [{ id: "lookup" }],
        };
      ...
      if (
        qData.url === "https://biothings.ncats.io/mgigene2phenotype/query" &&
        qData.data === "q=DOID:4325&scopes=mgi.associated_with_disease.doid"
      ) {
      ...
      if (
        qData.url === "https://biothings.ncats.io/DISEASES/query" &&
        qData.data === "q=DOID:4325&scopes=DISEASES.doid"
      ) {
      ...
      if (qData.url === "https://automat.transltr.io/biolink/1.3/query") {
        res = {
          message: {
            query_graph: {
              nodes: {
                n0: { ids: ["MONDO:0005737"], categories: ["biolink:Disease"], is_set: false, constraints: [] },
                n1: { ids: null, categories: ["biolink:Gene"], is_set: false, constraints: [] },
              },
              edges: {
                e01: {
                  subject: "n0",
                  object: "n1",
                  knowledge_type: null,
                  predicates: ["biolink:contribution_from"],
                  attribute_constraints: [],
                  qualifier_constraints: [],
                },
              },
        ...
        res = {
          message: {
            query_graph: {
              ...
              edges: {
                e01: { predicates: ["biolink:decreases_expression_of"], subject: "n0", object: "n1", constraints: [] },
              },
            },
            knowledge_graph: { nodes: {}, edges: {} },
            results: [],
          ...
          logs: [
            {
              timestamp: "2023-01-27T02:54:54.923048",
              level: "INFO",
              message: "Normalized curie: MONDO:0005737 to UMLS:C0282687",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:55.042431",
              level: "INFO",
              message: "Converted category biolink:Disease to biolink:Disease using Biolink semantic operations.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:55.042452",
              level: "INFO",
              message: "Converted category biolink:Gene to biolink:Gene using Biolink semantic operations.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:55.050923",
              level: "INFO",
              message:
                "Converted predicate biolink:decreases_expression_of to biolink:decreases_expression_of using Biolink semantic operations.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:55.254680",
              level: "INFO",
              message: "Disease with curie UMLS:C0282687 does not exist in the database.",
              code: null,
            },
            {
              timestamp: "2023-01-27T02:54:55.255578",
              level: "INFO",
              message: "Disease with curie UMLS:C0282687 does not exist in the database.",
              code: null,
            },
            { timestamp: "2023-01-27T02:54:55.264499", level: "INFO", message: "No results found.", code: null },
          ],
          id: "cfc39f7e-5398-422c-a200-e9561ca9dc45",
          status: "Success",
          description: null,
          workflow: [{ id: "lookup" }],
        };
      ...
      if (
        qData.url === "https://biothings.ncats.io/semmeddb/query" &&
        arrEquals(qData.data?.q?.[0], ["C0282687", "DISRUPTS", "gngm", 1, 1])
      ) {
        res = { max_total: 0, hits: [{ query: ["C0282687", "DISRUPTS", "gngm", 1, 1], notfound: true }] };
      }
      if (
        qData.url === "https://biothings.ncats.io/semmeddb/query" &&
        arrEquals(qData.data?.q?.[0], ["C0282687", "AFFECTS", "gngm", 1, 1])
      ) {
        res = {
          max_total: 7,
          hits: [
            {
              query: ["C0282687", "AFFECTS", "gngm", 1, 1],
              _id: "129653976",
              _score: 19.361662,
              object: { name: "Hemorrhagic Fever, Ebola", umls: "C0282687" },
              pmid: 19683682,
              predicate: "AFFECTS",
              subject: { name: "PTPRC gene", umls: "C1335285" },
            },
            {
              query: ["C0282687", "AFFECTS", "gngm", 1, 1],
              _id: "136992331",
              ...
              pmid: 25722412,
              predicate: "AFFECTS",
              subject: { name: "CCDC6 gene", umls: "C1425774" },
            },
            {
              query: ["C0282687", "AFFECTS", "gngm", 1, 1],
              _id: "135827604",
            ...
            },
            {
              ...
              pmid: 29717011,
              predicate: "AFFECTS",
              subject: { name: "Genes", umls: "C0017337" },
            },
            {
              query: ["C0282687", "AFFECTS", "gngm", 1, 1],
              _id: "147460221-2",
            ...
            },
            {
              ...
              pmid: 34160256,
              predicate: "AFFECTS",
              subject: { name: "Viral Genome", umls: "C0042720" },
            },
          ],
        };
      }
      ...
      if (
        qData.url === "https://biothings.ncats.io/semmeddb/query" &&
        arrEquals(qData.data?.q?.[0], ["C0751434", "CAUSES", "gngm", 1, 1])
      ) {
        res = {
          max_total: 3,
          hits: [
            {
              query: ["C0751434", "CAUSES", "gngm", 1, 1],
              _id: "108764506",
              _score: 20.859911,
              object: { name: "Classical phenylketonuria", umls: "C0751434" },
              pmid: 10495930,
              predicate: "CAUSES",
              subject: { name: "PAH gene", umls: "C1418251" },
            },
            {
              query: ["C0751434", "CAUSES", "gngm", 1, 1],
              _id: "164232103",
            ...
            { query: ["C4025094", "CAUSES", "gngm", 1, 1], notfound: true },
          ],
        };
      }
      return { data: res };
  ...
  test("POST /v1/query with query that doesn't provide input category", async () => {
    axios.default.mockImplementation(async qData => {
      ...
      if (qData.url === "https://api.monarchinitiative.org/api/bioentity/disease/MONDO:0019259/genes") {
        res = {
          associations: [
            {
              id: "29f0376e-6945-4252-8348-7be7e1562dc3",
              type: null,
              subject: {
                taxon: { id: null, label: null },
                id: "MONDO:0019259",
                label: "classic phenylketonuria",
                iri: "http://purl.obolibrary.org/obo/MONDO_0019259",
                category: ["disease"],
              },
              subject_eq: null,
              ...
              object: {
                ...
                id: "HGNC:8582",
                label: "PAH",
                iri: "https://www.genenames.org/data/gene-symbol-report/#!/hgnc_id/HGNC:8582",
                category: ["gene"],
              },
              object_eq: null,
              ...
              relation: {
                ...
                iri: "http://purl.obolibrary.org/obo/RO_0004012",
                category: null,
              },
              slim: null,
              negated: false,
              qualifiers: null,
              evidence_graph: { nodes: null, edges: null },
              evidence_types: [
                { id: "ECO:0000322", label: "imported manually asserted information used in automatic assertion" },
              ],
              provided_by: ["https://archive.monarchinitiative.org/#orphanet"],
              publications: [],
            },
          ],
          compact_associations: null,
    ...
    axios.default.post.mockImplementation(async (...q) => {
      ...
      if (arrEquals(qData?.curies, ["UMLS:C0751434"])) {
        res = {
          "UMLS:C0751434": {
            id: { identifier: "MONDO:0019259", label: "classic phenylketonuria" },
            equivalent_identifiers: [
              { identifier: "MONDO:0019259", label: "classic phenylketonuria" },
              { identifier: "ORPHANET:79254" },
              { identifier: "UMLS:C0751434", label: "Classical phenylketonuria" },
              { identifier: "UMLS:C4025094", label: "Reduced phenylalanine hydroxylase activity" },
              { identifier: "MEDDRA:10034875" },
              { identifier: "NCIT:C117117", label: "Classical Phenylketonuria" },
              { identifier: "HP:0005982", label: "Reduced phenylalanine hydroxylase level" },
            ],
            type: [
              "biolink:Disease",
              "biolink:DiseaseOrPhenotypicFeature",
      ...
      if (arrEquals(qData?.curies, ["UMLS:C0751434", "HGNC:8582", "UMLS:C1418251"])) {
        res = {
          ...
          "HGNC:8582": {
            id: { identifier: "NCBIGene:5053", label: "PAH" },
            equivalent_identifiers: [
              { identifier: "NCBIGene:5053", label: "PAH" },
              { identifier: "ENSEMBL:ENSG00000171759" },
              { identifier: "HGNC:8582", label: "PAH" },
              { identifier: "OMIM:612349" },
              { identifier: "UMLS:C1418251", label: "PAH gene" },
              { identifier: "UniProtKB:A0A024RBG4", label: "A0A024RBG4_HUMAN Phe-4-monooxygenase (trembl)" },
              { identifier: "UniProtKB:P00439", label: "PH4H_HUMAN Phenylalanine-4-hydroxylase (sprot)" },
              { identifier: "PR:P00439", label: "phenylalanine-4-hydroxylase (human)" },
              { identifier: "ENSEMBL:ENSP00000448059" },
            ],
            type: [
              "biolink:Gene",
              "biolink:GeneOrGeneProduct",
    ...
    await request(app)
      ...
      .then(response => {
        ...
        expect(response.body.message.knowledge_graph.nodes["NCBIGene:5053"]).toHaveProperty("categories", [
          "biolink:Gene",
        ]);
      });
  });
